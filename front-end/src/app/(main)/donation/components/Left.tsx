...
export const Left = () => {
  return (
    <div className="flex top-60 w-[632px] flex-col items-start h-auto gap-5 rounded-lg border-[1px] border-[#E4E4E5] text-[#09090B] bg-red-300">
      <div className="flex p-6 w-full flex-col items-start h-auto gap-2">
        <div className="flex w-full flex-row justify-between items-center gap-2  rounded-lg border-[1px] border-[#E4E4E7]">
      ...
      <div className="w-full h-[116px] flex p-6 flex-col items-start gap-3 rounded-lg border-[1px] border-[#E4E4E7]">
        <p className="text-[16px] font-semibold">Social media URL</p>
        <p className="text-[14px]">https://buymeacoffee.com/spacerulz44</p>
      </div>
      <div className="flex w-full h-[236px] p-6 flex-col items-start gap-6 rounded-lg border-[1px] border-[#E4E4E7]">
