      ...
      <div className="flex w-[580px] flex-col items-start gap-5">
        <div className="flex w-full flex-col items-start gap-2">
          ...
          <input
            ...
            className="flex w-full h-10 px-4 py2 items-center rounded-md border-[1px] border-[#E4E4E7]"
          ></input>
        </div>
        ...
        <div className="flex w-full flex-col items-start gap-2">
          ...
          <textarea
            ...
            className="flex w-full min-h-[80px] h-10 px-4 py2 items-center rounded-md border-[1px] border-[#E4E4E7]"
          ></textarea>
        </div>
      </div>
