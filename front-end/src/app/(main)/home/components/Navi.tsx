...
export const Navi = () => {
  ...
  return (
    <div className="flex pl-10 w-[251px] flex-col items-start gap-1">
      {buttons.map((v, i) => {
        return i == 2 ? (
          <button
            key={i}
            className="flex bg-[#F4F4F5] w-[200px] h-[36px] px-4 py-2 items-center gap-2 rounded-md text-[#18181B] text-[14px] font-medium"
          >
            {v}
