  ...
  return (
    <div
      ...
      <div className="bg-[#FBBF24] w-[50%] h-full flex justify-center items-center relative">
        ...
        <div className="text-[#09090B] flex flex-col items-center gap-10">
          <svg
            className="size-[140px] lg:size-[240px]"
          ...
          <div className="flex max-w-[455px] items-center flex-col gap-3">
            <p className="text-[20px] lg:text-[24px] font-bold text-center">
      ...
      <div className="bg-white w-[50%] h-full"> {children}</div>
    </div>
  );
}
